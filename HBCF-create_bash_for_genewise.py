...
path_to_seq = args.dna#'/workspace/markwelchlab/Haplotype_Based_Conversion_Finder/GENE_AND_PAIR_MINING/NEW_ALLELES/FASTA/'
...
for name in file_names:
    ...
    command_line = "#!/bin/bash" +"\n" +"genewise %s/%s %s/%s -gene worm.gf -cdna -pep -both" %(args.pep, peptide_fasta, args.dna, name) + " > %s.genewise.out.txt" %(name) 
